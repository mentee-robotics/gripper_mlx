...
if(_rs485_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED rs485_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(rs485_FOUND FALSE)
  elseif(NOT rs485_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(rs485_FOUND FALSE)
  endif()
  return()
endif()
set(_rs485_CONFIG_INCLUDED TRUE)

# output package information
if(NOT rs485_FIND_QUIETLY)
  message(STATUS "Found rs485: 0.0.0 (${rs485_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'rs485' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${rs485_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(rs485_FOUND_AMENT_PACKAGE TRUE)
