...
class BatteryStatus(metaclass=Metaclass_BatteryStatus):
    ...
    def vbat(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'vbat' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'vbat' field must be an integer in [-2147483648, 2147483647]"
        self._vbat = value
    ...
    def soc(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'soc' field must be an integer in [-2147483648, 2147483647]"
        self._soc = value
    ...
    def max_temp(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'max_temp' field must be an integer in [-2147483648, 2147483647]"
