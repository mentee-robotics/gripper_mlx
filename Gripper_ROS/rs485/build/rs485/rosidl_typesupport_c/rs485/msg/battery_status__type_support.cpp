...
static const _BatteryStatus_type_support_symbol_names_t _BatteryStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rs485, msg, BatteryStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rs485, msg, BatteryStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rs485, msg, BatteryStatus)() {
  return &::rs485::msg::rosidl_typesupport_c::BatteryStatus_message_type_support_handle;
}
