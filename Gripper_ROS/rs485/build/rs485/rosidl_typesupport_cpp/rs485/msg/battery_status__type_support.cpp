...
static const _BatteryStatus_type_support_symbol_names_t _BatteryStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rs485, msg, BatteryStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rs485, msg, BatteryStatus)),
  }
};
...
{
  return &::rs485::msg::rosidl_typesupport_cpp::BatteryStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rs485, msg, BatteryStatus)() {
  return get_message_type_support_handle<rs485::msg::BatteryStatus>();
}
